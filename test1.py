...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Active Directory Pro")
        self.geometry("850x450")
        self.iconbitmap("main_logo.png")
        ...
        self.chat_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(image_path, "modify_dark.png")),
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Active Directory Pro", image=self.logo_image,
